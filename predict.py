...
def main(MODEL_PATH,DATA_PATH):
    ...
    try:
        ...
        print(f"Date: {next_date.strftime('%d/%m/%Y')}")
        print(f"Predicted Price: {df['Close'].iloc[-1]}")
...
if __name__ == "__main__":
    # main('NULB/NublModel.pth','NULB/NUBL.csv')
    main('LLBS/LLBSmodel.pth','LLBS/LLBS.csv')
